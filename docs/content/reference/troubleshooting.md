...
Most of these come down to network reality or how danviet serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

danviet rate-limits like any public site. danviet already paces
...
Where a surface is gated, danviet reads a cookie or token you supply
...
`danviet`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what danviet actually did
